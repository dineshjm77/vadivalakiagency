...
$where = " WHERE c.assigned_lineman_id = {$linemanId}  AND o.status = 'delivered' AND IFNULL(o.payment_status,'pending') IN ('pending','partial')  ";
if ($search !== '') {
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body d-flex flex-wrap justify-content-between align-items-center gap-3">
                                <div>
                                    <h4 class="mb-1">Performance Invoice</h4>
                                    <div class="text-muted">Delivered invoices with pending or partial payment</div>
                                </div>
                                <div class="text-end">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5 class="mb-0">Performance Invoice List</h5>
