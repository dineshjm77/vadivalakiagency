                                            ...
                                            <table class="table table-hover table-centered mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><strong><?php echo htmlspecialchars($dist['company_name']); ?></strong></td>
                                                        <td><?php echo $dist['contact_person']; ?></td>
                                                        <td><?php echo $dist['phone']; ?></td>
                                                        <td><?php echo $dist['assigned_area'] ?: '-'; ?></td>
                                            ...
                                            <table class="table table-hover table-centered mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><strong><?php echo htmlspecialchars($lineman['full_name']); ?></strong></td>
                                                    ...
                                                    <tr>
                                                        <td colspan="7" class="text-center text-muted">No line men found</td>
                                                    </tr>
                                                    <?php endif; ?>
                                                </tbody>
                                            </table>
