...
function creditor_import_autoload(): bool {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['bulk_import_creditors'])) {
    ...
    if (!creditor_import_autoload()) {
        header('Location: creditors-list.php?msg=import_library_missing');
        exit;
    }
    ...
    try {
        ...
        if (count($sheet) < 2) throw new Exception('Empty import sheet');

        $headers = [];
        foreach ($sheet[2] ?? $sheet[1] as $col => $headerVal) {
            $headers[$col] = creditor_norm_header($headerVal);
        }
        ...
        for ($r = 3; $r <= count($sheet); $r++) {
            ...
            foreach ($headers as $col => $headerName) {
                if ($headerName !== '') $data[$headerName] = trim((string)($row[$col] ?? ''));
            }
            ...
            if ($existing) {
                ...
                if (creditor_has_column($conn, 'creditors', 'total_purchases') && !in_array('total_purchases', $cols, true)) {
                    $cols[] = 'total_purchases'; $placeholders[] = '0';
                }
        ...
        <div class="page-content">
            <div class="container-fluid">
                    ...
                    <div class="col-12">
                        <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                <a href="creditor-import-template.xlsx" class="btn btn-outline-info">
                ...
                <?php if (isset($_GET['msg'])): ?>
                    ...
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">Unable to import creditor Excel file. Please use the template and try again.<button type="button" class="btn-close" data-bs-dismiss="alert"></button></div>
                    <?php endif; ?>
                <?php endif; ?>
        ...
        <div class="modal-content">
            <form method="post" enctype="multipart/form-data">
                <div class="modal-header">
                    <h5 class="modal-title">Bulk Import Creditors</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <p class="text-muted mb-3">Download the Excel template, fill creditor rows, and upload the .xlsx file here.</p>
                    <div class="mb-3">
                ...
                <div class="modal-footer">
                    <a href="creditor-import-template.xlsx" class="btn btn-light border">Download Template</a>
